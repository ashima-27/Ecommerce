...
//           Showing{' '}
//           <span className='font-medium'>{page - 1}*ITEMS_PER_PAGE+1</span> to{' '}
...
//                 aria-current='page'
//                 className={` cursor-pointer relative z-10 inline-flex items-center px-4 py-2 text-sm font-semibold text-white${
//                   index + 1 === page
...
//                   <div
//                     key={product.id}
//                     className='relative p-2 border-2 border-solid group border-grey-200'
//                   >
